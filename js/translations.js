const translations = {
  en: {
    ...
    workExperience: [
      ...
      {
        title: 'Co-Owner and Brand Barista',
  ...
  fr: {
    ...
    workExperience: [
      ...
      {
        title: 'Responsable des ventes | Barista',
        company: 'Dim Kavy | Kyiv, Ukraine',
